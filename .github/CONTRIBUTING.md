...
1. Fork the project by navigating to the main [repository](https://github.com/ibm-frontend/website) and clicking the **Fork** button on the top-right corner.
...
3. Once cloned, you will see `origin` as your default remote, pointing to your personal forked repository. Add a remote named `upstream` pointing to the main `website`:

   ```
   $ git remote add upstream git@github.com:ibm-frontend/website.git
   $ git remote -v
   ```
...
8. In GitHub, navigate to [ibm-frontend/website](https://github.com/ibm-frontend/website) and click the button that reads "Compare & pull request".
